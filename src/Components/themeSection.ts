...
const themeSectionElements = (themeController: ThemeController) => {
     ...
     */
    const subscribeColourPicker = (colourToggleIndex: Colour) =>
        compute(themeController.selected, (theme) => {
     ...
     */
    const subscribeColourPickerActive = (colourToggleIndex: Colour) =>
        compute(themeController.selected, (theme) => {
            if (
                theme?.colours.themeColours.length &&
                theme.colours.themeColours.length > colourToggleIndex
            )
                return "visible";
            return "hidden";
        });

    const generateColourPicker = (index: number) =>
        colourPicker({
            colour: subscribeColourPicker(index),
            visibility: subscribeColourPickerActive(index),
        });

    const generateColourPickers = (
        startingIndex: number,
        endingIndex: number
    ) => {
        const acc = [];
        for (let i = startingIndex; i <= endingIndex; i += 1) {
            acc.push(generateColourPicker(i));
        }
        return [...acc];
    };
                ...
                content: [
                    box({
                        ...
                        content: vertical({
                            ...
                            content: [
                                dropdown({
                                    items: compute(themeController.all, (t) =>
                                        t.map((theme) => theme.name)
                                    ),
                                    selectedIndex:
                                    ...
                                    onChange: (index: number) => {
                                        themeController.selectedIndex.set(
                                            index
                                        );
                                        themeController.selected.set(
                                            themeController.all.get()[index]
                                        );
                                    },
                                }),
                                ...
                                horizontal({
                                    spacing: 0,
                                    content: [...generateColourPickers(0, 7)],
                                }),
                                ...
                                horizontal({
                                    ...
                                    content: [
                                        ...
                                        colourPicker({
                                            ...
                                            visibility:
                                                subscribeColourPickerActive(8),
                                        }),
                                        colourPicker({
                                            colour: subscribeColourPicker(9),
                                            visibility:
                                                subscribeColourPickerActive(9),
                                        }),
                                        colourPicker({
                                            colour: subscribeColourPicker(10),
                                            visibility:
                                                subscribeColourPickerActive(10),
                                        }),
                                        colourPicker({
                                            colour: subscribeColourPicker(11),
                                            visibility:
                                                subscribeColourPickerActive(11),
                                        }),
                                        colourPicker({
                                            colour: subscribeColourPicker(12),
                                            visibility:
                                                subscribeColourPickerActive(12),
                                        }),
                                        colourPicker({
                                            colour: subscribeColourPicker(13),
                                            visibility:
                                                subscribeColourPickerActive(13),
                                        }),
                                        colourPicker({
                                            colour: subscribeColourPicker(14),
                                            visibility:
                                                subscribeColourPickerActive(14),
                                        }),
                                        colourPicker({
                                            colour: subscribeColourPicker(15),
                                            visibility:
                                                subscribeColourPickerActive(15),
                                        }),
                                    ],
                                }),
                                ...
                                horizontal({
                                    ...
                                    content: [
                                        colourPicker({
                                            ...
                                            visibility:
                                                subscribeColourPickerActive(16),
                                        }),
                                        colourPicker({
                                            colour: subscribeColourPicker(17),
                                            visibility:
                                                subscribeColourPickerActive(17),
                                        }),
                                        colourPicker({
                                            colour: subscribeColourPicker(18),
                                            visibility:
                                                subscribeColourPickerActive(18),
                                        }),
                                        colourPicker({
                                            colour: subscribeColourPicker(19),
                                            visibility:
                                                subscribeColourPickerActive(19),
                                        }),
                                        colourPicker({
                                            colour: subscribeColourPicker(20),
                                            visibility:
                                                subscribeColourPickerActive(20),
                                        }),
                                        colourPicker({
                                            colour: subscribeColourPicker(21),
                                            visibility:
                                                subscribeColourPickerActive(21),
                                        }),
                                        colourPicker({
                                            colour: subscribeColourPicker(22),
                                            visibility:
                                                subscribeColourPickerActive(22),
                                        }),
                                        colourPicker({
                                            colour: subscribeColourPicker(23),
                                            visibility:
                                                subscribeColourPickerActive(23),
                                        }),
                                    ],
                                }),
                                // fourth row
                                horizontal({
                                    ...
                                    content: [
                                        colourPicker({
                                            ...
                                            visibility:
                                                subscribeColourPickerActive(24),
                                        }),
                                        colourPicker({
                                            colour: subscribeColourPicker(25),
                                            visibility:
                                                subscribeColourPickerActive(25),
                                        }),
                                        colourPicker({
                                            colour: subscribeColourPicker(26),
                                            visibility:
                                                subscribeColourPickerActive(26),
                                        }),
                                        colourPicker({
                                            colour: subscribeColourPicker(27),
                                            visibility:
                                                subscribeColourPickerActive(27),
                                        }),
                                        colourPicker({
                                            colour: subscribeColourPicker(28),
                                            visibility:
                                                subscribeColourPickerActive(28),
                                        }),
                                        colourPicker({
                                            colour: subscribeColourPicker(29),
                                            visibility:
                                                subscribeColourPickerActive(29),
                                        }),
                                        colourPicker({
                                            colour: subscribeColourPicker(30),
                                            visibility:
                                                subscribeColourPickerActive(30),
                                        }),
                                        colourPicker({
                                            colour: subscribeColourPicker(31),
                                            visibility:
                                                subscribeColourPickerActive(31),
                                        }),
                                    ],
                                }),
                            ],
