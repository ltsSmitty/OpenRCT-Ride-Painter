...
const modeSectionElements = (mc: ModeController) => {
  ...
  const enableRideColourPicker = (index: number) => {
    ...
    debug(`Enabled colourPickers changed to ${enabledColours}`);
  };

  /**
   * @param partNumber is 0 through 5 representing track/car part
  ...
  const customPatternColourPickerElement = (partNumber: number) => {
    const element = colourPicker({
      ...
      colour: compute(
        ...
        (colours) => colours[partNumber]
      ),
      disabled: compute(
        mc.selectedColoursEnabled,
        (enabledColours) => !enabledColours[partNumber]
      ),
      ...
      onChange: (colourChosen: Colour) => {
        mc.selectedCustomColours.update(partNumber, colourChosen);
      },
    });
    return element;
  };
    ...
    horizontal({
      ...
      content: [
        toggle({
          ...
          isPressed: compute(
            mc.selectedColoursEnabled,
            (enabledColours) => enabledColours[0]
          ),
        ...
        toggle({
          ...
          isPressed: compute(
            mc.selectedColoursEnabled,
            (enabledColours) => enabledColours[1]
          ),
        ...
        toggle({
          ...
          isPressed: compute(
            mc.selectedColoursEnabled,
            (enabledColours) => enabledColours[2]
          ),
        ...
        toggle({
          ...
          isPressed: compute(
            mc.selectedColoursEnabled,
            (enabledColours) => enabledColours[3]
          ),
        ...
        toggle({
          ...
          isPressed: compute(
            mc.selectedColoursEnabled,
            (enabledColours) => enabledColours[4]
          ),
        ...
        toggle({
          ...
          isPressed: compute(
            mc.selectedColoursEnabled,
            (enabledColours) => enabledColours[5]
          ),
