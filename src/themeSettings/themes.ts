...
export interface Theme {
    ...
    colours: {
        ...
        themeColours: number[];
        // !curently unused
        // Preselected RideColour combinations that you know look good.
        // Can include colors different from themeColours above
...
const dazzlingColors: Theme = {
    ...
    description:
        'Color scheme qualifies park for the "Most Dazzling Ride Colors" award.',
    colours: {
